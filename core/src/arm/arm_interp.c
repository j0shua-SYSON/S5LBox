...
static bool vfp_lazy_enable_trap(const arm_cpu_t *c, uint32_t insn) {
    ...
    if (a8_neon_single_elements_space(c, insn) || a8_neon_pairs_space(c, insn) || a8_neon_bitwise_space(c, insn) ||
        ...
        a8_neon_macc_space(c, insn) || a8_neon_by_scalar_space(c, insn) || a8_neon_integer_space(c, insn)) return false;
    ...
    if (cond == 0xfu) {
        ...
        if (a8_neon_bitwise_space(c, insn) || a8_neon_immediate_space(c, insn) ||
            ...
            arm_status_t status = a8_neon_bitwise_space(c, insn) ? exec_a8_neon_bitwise(c, insn) :
                ...
                a8_neon_integer_space(c, insn) ? exec_a8_neon_integer(c, insn) : exec_a8_neon_macc(c, insn);
