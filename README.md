...
- **30 fps is not established.** The currently installed iOS app is reported at
  ...
  the target. r461/r463's direct restored desktop meter observed only
...
is explicit and never runs at startup. The best symmetric live-guest desktop core A/B
averages 15.69 M instructions/s after r458. A later direct MBX publication measurement
averages 10.816–11.449 changed scanouts/s on desktop, with no 30 fps window. The current
phone report is roughly 0–4 fps, without an exact-build execution/publication
breakdown; it is nowhere near a measured 30 fps result.
