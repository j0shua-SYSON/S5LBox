...
static const uint8_t *vm_guest_record_display(const s5l8900_t *m,
    ...
    if (m) {
        ...
        if (vm_frame_telemetry_is_enabled()) {
            ...
            execution.compact_data_refill_attempts =
                s5l8900_static_a64_compact_raw_data_refill_attempts(m);
            execution.compact_data_fast_refills =
                s5l8900_static_a64_compact_raw_data_fast_refills(m);
            execution.compact_window_cache_hits =
                s5l8900_static_a64_compact_raw_window_cache_hits(m);
            execution.compact_bulk_calls =
            ...
            execution.compact_ram_map_fetch = s5l8900_static_a64_compact_ram_map_fetch(m);
            execution.compact_ram_map_read = s5l8900_static_a64_compact_ram_map_read(m);
            execution.compact_ram_map_write = s5l8900_static_a64_compact_ram_map_write(m);
