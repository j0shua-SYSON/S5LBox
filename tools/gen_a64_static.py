...
def compact_vfp_memory_body() -> list[str]:
    ...
    return [
        ...
        ".La64cr_vfp_memory_lookup:",
        "    ldr x0, [x27, #0]",
        "    cbz x0, .La64cr_vfp_memory_lookup_cache",
        "    ldr w1, [x27, #8]",
        "    and w2, w10, w1",
        "    add x0, x0, w2, uxtw",
        "    mov x1, xzr",
        "    mov w2, #1",
        "    ret",
        ".La64cr_vfp_memory_lookup_cache:",
        "    cbz w15, .La64cr_vfp_memory_lookup_write",
        "    ldr x0, [x27, #16]",
        "    ldr x1, [x27, #32]",
        "    b .La64cr_vfp_memory_lookup_common",
        ".La64cr_vfp_memory_lookup_write:",
        "    ldr x0, [x27, #24]",
        "    ldr x1, [x27, #40]",
        ".La64cr_vfp_memory_lookup_common:",
        "    cbz x0, .La64cr_vfp_memory_lookup_fail",
        "    cbz x1, .La64cr_vfp_memory_lookup_fail",
        "    ldr w2, [x27, #84]",
        "    lsr w3, w10, #10",
        "    add w3, w3, w2, lsl #5",
        "    and w3, w3, #63",
        "    add x0, x0, w3, uxtw #4",
        "    ldr x2, [x0, #0]",
        "    cbz x2, .La64cr_vfp_memory_lookup_fail",
        "    lsr w3, w10, #10",
        "    lsl w3, w3, #10",
        "    ldr w4, [x27, #84]",
        "    orr w3, w3, w4",
        "    ldr w4, [x0, #8]",
        "    cmp w4, w3",
        "    b.ne .La64cr_vfp_memory_lookup_fail",
        "    ldr w4, [x0, #12]",
        "    ldr w3, [x27, #80]",
        "    cmp w4, w3",
        "    b.ne .La64cr_vfp_memory_lookup_fail",
...
def compact_raw_function() -> list[str]:
    ...
    return [
        ...
        *compact_vfp_nonarith_body(),
        ...
        "    .long .La64cr_thumb_sp_adjust - .La64cr_thumb_top_table",
        "    .long .La64cr_fallback - .La64cr_thumb_top_table",
