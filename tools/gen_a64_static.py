...
def compact_vfp_memory_body() -> list[str]:
    ...
    return [
        ...
        "    cbz w15, .La64cr_memory_lookup_write",
        "    ldr x0, [x27, #16]",
        "    ldr x1, [x27, #32]",
...
def compact_raw_function() -> list[str]:
    ...
    return [
        ...
        "",
        ".La64cr_block:",
        # Ordinary A32 STM/LDM, including every address mode and safe
        # writeback form. The S/user-bank forms and LDM-to-PC remain literal.
        ...
        "    mov x7, x1",
        "    mov w8, wzr",
        "    tbnz w9, #20, .La64cr_block_load_loop",
